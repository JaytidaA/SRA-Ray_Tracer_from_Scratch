...
// Method for Clearing and Checking Errors
...
int main()
{
	...
	my_Window = glfwCreateWindow(640, 640, "Video 10: Handling Errors", NULL, NULL);
	...
	while(!glfwWindowShouldClose(my_Window)){	
		...
		GL_clear_error();
		glDrawElements(GL_TRIANGLES, 6, GL_INT, nullptr);	//Line in which error occurs
		GL_check_error();
